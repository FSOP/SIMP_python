class iface_SQL:
    ...
    sql_notice_query_leo = "select message_id from satcat, " \
                           ...
                           "o.miss_distance < {} and o.collision_probability > {}".format(orbit_leo_period_criteria, miss_distance_leo, probability_criteria)
    ...
    sql_notice_query_geo = "select message_id from satcat, " \
                           ...
                           "satcat.orbital_period {} and o.miss_distance < {}".format(orbit_geo_period_criteria, miss_distance_geo)
